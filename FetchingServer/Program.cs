...
namespace FetchingServer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            WebApiServer.listener.Prefixes.Add("http://10.150.0.53:8000/");
            WebApiServer.listener.Prefixes.Add("http://127.0.0.1:8000/");
            WebApiServer.listener.Prefixes.Add("http://localhost:8000/");
